...
type LoginRequest struct {
	...
	Identifiers isLoginRequest_Identifiers `protobuf_oneof:"identifiers"`
...
func (m *LoginRequest) GetIdentifiers() isLoginRequest_Identifiers {
	if m != nil {
...
func (x *LoginRequest) GetEmail() string {
	if x, ok := x.GetIdentifiers().(*LoginRequest_Email); ok {
		return x.Email
	}
	return ""
}
...
func (x *LoginRequest) GetUsername() string {
	if x, ok := x.GetIdentifiers().(*LoginRequest_Username); ok {
		return x.Username
	}
	return ""
}
...
func (x *LoginRequest) GetPhoneNumber() string {
	if x, ok := x.GetIdentifiers().(*LoginRequest_PhoneNumber); ok {
...
type isLoginRequest_Identifiers interface {
	isLoginRequest_Identifiers()
}
...
func (*LoginRequest_Email) isLoginRequest_Identifiers() {}

func (*LoginRequest_Username) isLoginRequest_Identifiers() {}

func (*LoginRequest_PhoneNumber) isLoginRequest_Identifiers() {}
...
type AuthorizationResponse struct {
	...
	AllowedMethods []string `protobuf:"bytes,1,rep,name=allowedMethods,proto3" json:"allowedMethods,omitempty"`
}
...
func (x *AuthorizationResponse) GetAllowedMethods() []string {
	if x != nil {
...
var file_protos_auth_proto_rawDesc = []byte{
	...
	0x6f, 0x74, 0x6f, 0x12, 0x07, 0x61, 0x75, 0x74, 0x68, 0x2e, 0x76, 0x31, 0x22, 0xa8, 0x01, 0x0a,
	...
	0x65, 0x6d, 0x61, 0x69, 0x6c, 0x12, 0x1c, 0x0a, 0x08, 0x75, 0x73, 0x65, 0x72, 0x6e, 0x61, 0x6d,
	...
	0x28, 0x09, 0x52, 0x04, 0x72, 0x6f, 0x6c, 0x65, 0x42, 0x0d, 0x0a, 0x0b, 0x69, 0x64, 0x65, 0x6e,
	0x74, 0x69, 0x66, 0x69, 0x65, 0x72, 0x73, 0x22, 0x25, 0x0a, 0x0d, 0x4c, 0x6f, 0x67, 0x69, 0x6e,
	...
	0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x05, 0x74, 0x6f, 0x6b, 0x65, 0x6e, 0x22, 0x3f, 0x0a, 0x15,
	0x41, 0x75, 0x74, 0x68, 0x6f, 0x72, 0x69, 0x7a, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x52, 0x65, 0x73,
	0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x26, 0x0a, 0x0e, 0x61, 0x6c, 0x6c, 0x6f, 0x77, 0x65, 0x64,
	0x4d, 0x65, 0x74, 0x68, 0x6f, 0x64, 0x73, 0x18, 0x01, 0x20, 0x03, 0x28, 0x09, 0x52, 0x0e, 0x61,
	0x6c, 0x6c, 0x6f, 0x77, 0x65, 0x64, 0x4d, 0x65, 0x74, 0x68, 0x6f, 0x64, 0x73, 0x32, 0x95, 0x01,
	0x0a, 0x04, 0x41, 0x75, 0x74, 0x68, 0x12, 0x36, 0x0a, 0x05, 0x4c, 0x6f, 0x67, 0x69, 0x6e, 0x12,
	...
	0x2e, 0x4c, 0x6f, 0x67, 0x69, 0x6e, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x55,
	0x0a, 0x14, 0x43, 0x68, 0x65, 0x63, 0x6b, 0x50, 0x65, 0x72, 0x6d, 0x69, 0x73, 0x73, 0x69, 0x6f,
	0x6e, 0x53, 0x63, 0x6f, 0x70, 0x65, 0x12, 0x1d, 0x2e, 0x61, 0x75, 0x74, 0x68, 0x2e, 0x76, 0x31,
	...
	0x41, 0x75, 0x74, 0x68, 0x6f, 0x72, 0x69, 0x7a, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x52, 0x65, 0x73,
	0x70, 0x6f, 0x6e, 0x73, 0x65, 0x42, 0x67, 0x0a, 0x0b, 0x63, 0x6f, 0x6d, 0x2e, 0x61, 0x75, 0x74,
	0x68, 0x2e, 0x76, 0x31, 0x42, 0x09, 0x41, 0x75, 0x74, 0x68, 0x50, 0x72, 0x6f, 0x74, 0x6f, 0x50,
	0x01, 0x5a, 0x10, 0x70, 0x62, 0x2f, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x73, 0x3b, 0x61, 0x75, 0x74,
...
var file_protos_auth_proto_goTypes = []any{
	...
	(*AuthorizationRequest)(nil),  // 2: auth.v1.AuthorizationRequest
	(*AuthorizationResponse)(nil), // 3: auth.v1.AuthorizationResponse
}
var file_protos_auth_proto_depIdxs = []int32{
	0, // 0: auth.v1.Auth.Login:input_type -> auth.v1.LoginRequest
	2, // 1: auth.v1.Auth.CheckPermissionScope:input_type -> auth.v1.AuthorizationRequest
	1, // 2: auth.v1.Auth.Login:output_type -> auth.v1.LoginResponse
	3, // 3: auth.v1.Auth.CheckPermissionScope:output_type -> auth.v1.AuthorizationResponse
